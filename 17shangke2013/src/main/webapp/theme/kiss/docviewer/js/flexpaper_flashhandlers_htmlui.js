    ...
    jQuery.fn.showFullScreen = function()
    {
         ...
         else
         {
             ...
             if (document.documentElement.requestFullScreen) {
                 ...
                 jQuery(this).parent().css({position: 'absolute',left: '0px',top: '0px',width : '100%',height: (100-topMargin-bottomMargin)+'%'});
             } else{
                 ...
                 flexPaperSnip = flexPaperSnip.replace(jQuery(this).parent().find('.flexpaper_zoomSlider').outer(),'<div id="zoomSliderFullScreen" class="flexpaper_slider"><div class="flexpaper_handle"><img src="images/sliderdot.gif"/></div></div>');
