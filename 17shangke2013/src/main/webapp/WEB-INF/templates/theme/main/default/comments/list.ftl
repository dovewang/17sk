...
<dl class="list-item small" action-type="comment-item" commentid="${m. commentId}">
	<dt class="face">
		<a href="/u/${m.userId}.html" target="_blank"><img usercard="${m.userId}" src="/theme/school/default/images/noface_s.jpg" width="40" height="40" alt=""/></a>
	</dt>
	<dd class="content">
		<p>
