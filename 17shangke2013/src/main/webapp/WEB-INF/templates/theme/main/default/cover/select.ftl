<div class="pop-header" style="padding:0"> <a node-type='pop-close' class='close' href='javascript:;'>×</a>
  <div class="tab-header" node-type="tabnavigator" style="border-top:none; border-left:none; border-right:none" mode="hash">
    <ul>
      <li> <a href="#!1" autoload="true" remote="false" view="#coverUploadView" mode="hash">封面上传</a> </li>
      <li> <a href="#!/cover/list.html?t=0"  view="#coverSelectView">默认图片</a> </li>
      <li> <a href="#!3"  view="#coverOnlineView">在线制图</a> </li>
    </ul>
  </div>
</div>
<div class="pop-body">
  <div style="height:550px;">
    <div id="coverUploadView"  class="tab-view">
      <div class="text-left">
      ...
      <div id="cover-area" class="clearfix">
        <div id="cover-source">
          <h2>课程封面图</h2>
          <p> 仅支持jpg、png、bmp格式图片，且文件小于1M </p>
        </div>
      ...
      <div>
        <button class="button primary large"  onClick="Course.saveCover()"> 保存 </button>
        <button class="button large" node-type="pop-close"> 取消 </button>
      </div>
    </div>
    <div id="coverSelectView" class="tab-view"> </div>
    <div class="tab-view" id="coverOnlineView">
