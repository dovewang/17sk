				...
				<div class="page-left">
					<div class="course-detail box">
						...
						<div class="course-mark">
							<#assign sc=domainHelper.getDomainById(course.schoolId)/> <span class="float-right">来自<a href="http://${sc.domain}.17shangke.com/about.html" target="_blank"> ${sc.name} </a></span>
							<span>发布时间：${helper.passTime(course.publishTime)}</span>
