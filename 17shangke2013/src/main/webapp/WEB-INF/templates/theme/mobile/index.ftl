...
<link href="/theme/mobile/css/jqtouch.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/theme/mobile/zepto.min.js"></script>
<script type="text/javascript"  src="/theme/mobile/jqtouch.min.js"></script>
...
<body>
  <div id="jqt">
            ...
            <div id="home" class="current">
                <div class="toolbar">
                    <h1>一起上课</h1>
                    <a class="button slideup" id="infoButton" href="#about">关于我们</a>
                </div>
                <div class="scroll">
                    <ul class="rounded">
