package flint.business.payment.alipay.config;
...
public class AlipayConfig {
	...
	// 必须保证其地址能够在互联网中访问的到
	public static String notify_url = "http://www.17shangke.com/payment/alipay.notify.html";

	// 当前页面跳转后的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
	// 域名不能写成http://localhost/create_direct_pay_by_user_jsp_utf8/return_url.jsp
	// ，否则会导致return_url执行无效
	public static String return_url = "http://127.0.0.1:8080/payment/alipay.return.html";
