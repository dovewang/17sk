...
@Table(name = "TB_QUESTION_COMMENTS", primary = { "COMMENT_ID" })
public class QuestionComments implements  Entity{
	...
	*/
    ...
    public QuestionComments(long commentId )
    {
   ...
   @Override
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
          QuestionComments  entity=(QuestionComments)o;
